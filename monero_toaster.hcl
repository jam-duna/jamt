...
# Download unified rollup stream runner
...
# Download all seeds (0-5 validators + 6 for rollup stream runner)
...
# Kill any leftover rollup-stream-runner processes
pkill -f "rollup-stream-runner" || true
sleep 2
